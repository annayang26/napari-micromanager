...
class MicroManagerWidget(QWidget):
    """The main napari-micromanager GUI widget."""
    ...
    def _create_stage_wdg(self):
        ...
        stages_coll.layout().setContentsMargins(0, 0, 0, 0)
...
#         self.tab_wdg.tabWidget.addTab(
#            self.group_preset_table_wdg, "Groups and Presets"
#        )
